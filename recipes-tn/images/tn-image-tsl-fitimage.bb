...
IMAGE_FSTYPES:remove = "tar tar.bz2 ext4 sdcard sdcard.bz2 sdcard.xz sdcard.md5sum"
WKS_FILE = "tn-spl-uboot-fit.wks.in"
WKS_FILE:mx8-nxp-bsp = "tn-imx8-imxboot-fit.wks.in"
#WKS_FILE_DEPENDS += ""
...
IMAGE_INSTALL:remove = "packagegroup-core-boot packagegroup-base-extended get-support-info packagegroup-tn-tools "
